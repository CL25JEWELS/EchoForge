...
export const SocialScreen: React.FC<SocialScreenProps> = ({ app, className = '' }) => {
  ...
  // ⚡ Bolt: Separate loading state for pagination to prevent list unmount/remount
  ...
  // ⚡ Bolt: Memoize handlers to prevent unnecessary re-renders of TrackFeed and TrackCards
  ...
  }, [feed, loadingMore, apiService, selectedFeedType]);
