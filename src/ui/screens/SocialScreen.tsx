...
export const SocialScreen: React.FC<SocialScreenProps> = ({ app, className = '' }) => {
  ...
  // ⚡ Bolt: Memoize loadFeed to prevent unnecessary re-renders and enable use in dependency arrays
  ...
  }, [selectedFeedType, apiService]);

  useEffect(() => {
    loadFeed();
  }, [loadFeed]);

  // ⚡ Bolt: Memoize callbacks to prevent unnecessary re-renders of TrackCard components
  ...
  }, [feed, selectedFeedType, apiService]);
