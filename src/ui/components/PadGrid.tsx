...
export const PadGrid: React.FC<PadGridProps> = React.memo(
  ({ pads, padStates, onPadTrigger, onPadStop, columns = 4, className = '' }) => {
    ...
    // This is a crucial optimization because this component re-renders frequently (every 50ms).
    // By memoizing the style, we avoid unnecessary style recalculations in the browser.
