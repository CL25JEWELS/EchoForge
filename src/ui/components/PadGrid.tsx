...
export const PadGrid: React.FC<PadGridProps> = React.memo(
  ({ pads, padStates, onPadTrigger, onPadStop, columns = 4, className = '' }) => {
    ...
    // While this component is already memoized, providing a stable object reference
    // to the underlying div's style prop avoids unnecessary DOM style recalculations
    // during a re-render.
