...
export const PadGrid: React.FC<PadGridProps> = React.memo(
  ({ pads, padStates, onPadTrigger, onPadStop, columns = 4, className = '' }) => {
    ...
    // This avoids unnecessary style recalculations in the browser and reduces React's diffing work,
    // even when the component itself doesn't re-render due to React.memo.
