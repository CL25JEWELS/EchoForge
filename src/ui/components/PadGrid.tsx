...
export const PadGrid: React.FC<PadGridProps> = React.memo(
  ({ pads, padStates, onPadTrigger, onPadStop, columns = 4, className = '' }) => {
    // ⚡ Bolt: Memoize the style object to prevent creating a new object on every render.
    // This is a common React optimization that avoids unnecessary re-renders and style recalculations,
    // especially when passing the style object to memoized child components.
